...
public class MateInjector {
    private static final Map<String, MateInjector> injectors = new HashMap<>();

    private Map<Class, Object> instanceOfClasses = new HashMap<>();
    private List<Class> classes = new ArrayList<>();

    private MateInjector(String mainPackageName) {
        try {
    ...
    public static MateInjector getInstance(String mainPackageName) {
        if (injectors.containsKey(mainPackageName)) {
            return injectors.get(mainPackageName);
        }
        MateInjector injector = new MateInjector(mainPackageName);
